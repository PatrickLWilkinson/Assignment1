...
print(f"There are {len(loan_costs)} loans.")
...
if len(loan_costs)>0:
    print(f"Average loan costs is ${sum(loan_costs)/len(loan_costs)}")
else:
...
present_value = present_value_calc(new_loan.get("future_value"),new_loan.get("remaining_months"),0.2)
print(f"Present Value of new_loan = {present_value}")
